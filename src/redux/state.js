            ...
            message: [
                {
                    id: 1,
                    message: 'hello1',
                    src: 'https://fainaidea.com/wp-content/uploads/2019/06/acastro_190322_1777_apple_streaming_0003.0.jpg'
                },
...
export let updateNewPostTextActionCreatorDialogs = (text) => ({
    type: UPDATE_NEW_POST_TEXT_DIALOGS,
    textStringDialogs: text
})
