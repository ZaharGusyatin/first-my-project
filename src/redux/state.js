...
export const addPostDialogs=()=>{
    let newPost = {
        id: 6,
        message: state.messagesPage.newPostTextDialogs,
    }
    state.messagesPage.messages.push(newPost)
    state.messagesPage.newPostTextDialogs=''
    rerenderEntireTree()
}
export const updateNewPostTextDialogs=(postMessageDialogs)=>{
    state.messagesPage.newPostTextDialogs=postMessageDialogs
    rerenderEntireTree()
}
